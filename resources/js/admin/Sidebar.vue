                ...
                <div class="collapse navbar-collapse w-100">
                    <ul class="flex-md-column flex-row navbar-nav w-100 justify-content-between">
                        <li class="nav-item d-none d-md-block">
                            <a class="nav-link p-3 text-nowrap active text-center" href="#">
                        ...
                        <li class="nav-item">
                            <a class="nav-link p-3" href="#"><span class="material-icons">perm_media</span> <span class="d-none d-md-inline"> Media</span></a>
                        </li>
                        <li class="nav-item">
